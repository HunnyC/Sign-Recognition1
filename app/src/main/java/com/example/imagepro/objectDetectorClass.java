...
public class  objectDetectorClass {
    ...
    private  int width=0;
    private int Clssification_Input_Size=0;
    ...
    objectDetectorClass(AssetManager assetManager,String modelPath, String labelPath,int inputSize,String classification_model,int classification_input_size ) throws IOException {
        ...
        Clssification_Input_Size = classification_input_size;
      ...
      //  float[][][]result=new float[1][10][4];
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Bitmap scaledBitmap1=Bitmap.createScaledBitmap(bitmap1,Clssification_Input_Size, Clssification_Input_Size,false);
    ...
    private String get_alphabets(float sig_v) {
        ...
        if(sig_v>=-0.5 &sig_v<0.5){
            ...
            val="W";
        }  else if(sig_v>=25.5&sig_v<26.5){
            val="X";
        }  else if(sig_v>=26.5&sig_v<27.5){
            val="Y";
        } return val;
